        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CurrentVersion = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseKey = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaxDevices = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionId = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IpAddress = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorMessage = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClientGuid = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HubCommands", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HubCommands_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EventDataJson = table.Column<string>(type: "json", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OccurredAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationVersions_ApplicationId_ReleasedAt",
                table: "ApplicationVersions",
                columns: new[] { "ApplicationId", "ReleasedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceSessions_ConnectionId",
                table: "DeviceSessions",
                column: "ConnectionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeviceSessions_DeviceId_ConnectedAt",
                table: "DeviceSessions",
                columns: new[] { "DeviceId", "ConnectedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_HubCommands_ClientGuid",
                table: "HubCommands",
                column: "ClientGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HubCommands_DeviceId_Status_SentAt",
                table: "HubCommands",
                columns: new[] { "DeviceId", "Status", "SentAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Licenses_ApplicationId_UserId",
                table: "Licenses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Telemetries_DeviceId_EventType_ReceivedAt",
                table: "Telemetries",
                columns: new[] { "DeviceId", "EventType", "ReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Telemetries_ReceivedAt",
                table: "Telemetries",
                column: "ReceivedAt");
